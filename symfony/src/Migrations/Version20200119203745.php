 ...
 */
final class Version20200119203745 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE campaign ADD CONSTRAINT FK_1F1512DD2534008B FOREIGN KEY (structure_id) REFERENCES structure (id)');
