 ...
 */
final class Version20210330203058 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE structure DROP identifier');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX pf_extid_idx ON structure');
        $this->addSql('ALTER TABLE structure ADD identifier INT DEFAULT NULL');
