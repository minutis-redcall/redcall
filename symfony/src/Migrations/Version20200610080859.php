 ...
 */
final class Version20200610080859 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE token (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(64) NOT NULL, secret VARCHAR(64) NOT NULL, hit_count INT DEFAULT NULL, last_hit_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
