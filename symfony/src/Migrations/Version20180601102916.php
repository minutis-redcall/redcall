 ...
 */
final class Version20180601102916 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE volunteer_status (id INT AUTO_INCREMENT NOT NULL, campaign_id INT DEFAULT NULL, volunteer_id INT DEFAULT NULL, checked_in_at DATETIME NOT NULL, checked_out_at DATETIME NOT NULL, INDEX IDX_288198F1F639F774 (campaign_id), INDEX IDX_288198F18EFAB6B1 (volunteer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
