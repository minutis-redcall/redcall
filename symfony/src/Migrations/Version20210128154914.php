 ...
 */
final class Version20210128154914 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(32) NOT NULL, message_count INT NOT NULL, answer_count INT NOT NULL, choice_count INT NOT NULL, bounce_count INT NOT NULL, answer_ratio INT NOT NULL, updated_at DATETIME NOT NULL, cost VARCHAR(64) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
