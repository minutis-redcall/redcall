 ...
 */
final class Version20210128165723 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(32) NOT NULL, message_count INT NOT NULL, answer_count INT NOT NULL, choice_count INT NOT NULL, bounce_count INT NOT NULL, answer_ratio INT DEFAULT NULL, updated_at DATETIME NOT NULL, cost VARCHAR(64) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE report_repartition (id INT AUTO_INCREMENT NOT NULL, structure_id INT DEFAULT NULL, report_id INT NOT NULL, ratio INT NOT NULL, message_count INT NOT NULL, answer_count INT NOT NULL, bounce_count INT NOT NULL, answer_ratio INT DEFAULT NULL, INDEX IDX_33AF3AA82534008B (structure_id), INDEX IDX_33AF3AA84BD2A4C0 (report_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
